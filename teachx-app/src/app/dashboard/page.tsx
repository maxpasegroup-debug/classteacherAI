...
import { mainClassteacherOrigin, nexaWorkspaceUrl } from "@/lib/main-app";
      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-4 sm:px-6">
          ...
          <nav className="flex flex-wrap items-center gap-2 text-sm">
            <Link
              href={nexaWorkspaceUrl()}
              className="rounded-lg px-3 py-1.5 font-medium text-slate-700 hover:bg-slate-100"
            >
              Nexa
            </Link>
            <Link href="/pricing" className="rounded-lg px-3 py-1.5 font-medium text-slate-700 hover:bg-slate-100">
              Pricing
            </Link>
            <Link
              href="/business"
