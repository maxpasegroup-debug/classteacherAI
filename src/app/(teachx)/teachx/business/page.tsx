    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-3">
          <Link href="/teachx/business/teaching" className="group block rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:border-slate-300 hover:shadow-md">
          ...
          <Link
            href="/teachx/business/rootscare"
          ...
          <Link href="/teachx/business/skills" className="group block rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:border-slate-300 hover:shadow-md">
